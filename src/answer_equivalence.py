...
VERSION = 'eq-conservative-20260905'
...
def normalize(value):
    ...
    text = re.sub(r'\bus\$|\$', ' USD ', text, flags=re.I)
...
def fast_match(gold, prediction):
    ...
    pattern = r'(usd |eur |gbp )?([+-]?\d+(?:\.\d+)?)(?: (percent|percentage points|million|billion|trillion|km|kg|miles))?'
